...
@section('content')
  <style>
    ...
    <form action="{{ route('signleBlogUpdate',$post->id) }}" method="post" enctype="multipart/form-data">
       @csrf
      <div class="card">
          <div class="body">
            ...
            <h4 class="text-center" style="color: #F96332;" id="message">{{ Session::get('message') }}</h4>
              <div class="form-group">
                  <input type="text" class="form-control" name="postTitle" placeholder="Post Title" value="{{ $post->postTitle }}"/>
              ...
              <div class="form-group" style="margin-bottom: 30px;">
                  <textarea type="text" id="editor" class="form-control editor1" rows="5" name="postDes"> {{ $post->postDes }}</textarea>
              </div>
